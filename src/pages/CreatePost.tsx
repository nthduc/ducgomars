        ...
        <section className="max-7-7xl mx-auto">
            <div>
                ...
                <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">
                    Create imaginative and visually stunning images generated by DALL-E-2 AI and share them with the
                    community
                </p>
            </div>
            ...
            <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
                ...
                <div className="mt-10 text-[#666e75]">
                    <p>Once you have created the image you want, you can share it with others in the commuity</p>
                    <button
                        type="submit"
